# SNCS v4 reviewer-proofing summary
...
See section 3 above; every script writes CSV+JSON+MD into `results/sncs_v4/`. Fixed seeds are used throughout (quadratic 0-4, MNIST 0-2, big models seed 0+).
