...
`REVIEW_EXPERIMENT_SUMMARY.md` for the captured console output.
...
| Repaired displacement metric (θ-commensurate δ) | (none -- Python only) | -- | **no** | -- | `scripts/review_experiments_common.py: metric_delta/full_repaired`. A modelling choice validated empirically (experiment 7), not a Lean object. |
