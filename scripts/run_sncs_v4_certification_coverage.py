"""SNCS v4 -- Experiment 2: Certification coverage.
...
Usage:
    .venv\\Scripts\\python.exe scripts/run_sncs_v4_certification_coverage.py
    .venv\\Scripts\\python.exe scripts/run_sncs_v4_certification_coverage.py --models quadratic mnist_mlp resnet18 gpt_mini
"""
import argparse
import sys
...
def main():
    ...
    lines = ["# Experiment 2 -- Certification coverage", "", C.ANALYZER_DISCLAIMER, "",
             ...
             "Exact command:", "", "```",
             "python scripts/run_sncs_v4_certification_coverage.py --models "
             + " ".join(args.models), "```", "",
             "## Overall", "",
             C.md_table(
                 ["metric", "value"],
