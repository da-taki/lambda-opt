...
Usage:
    .venv\\Scripts\\python.exe scripts/run_runtime_overhead.py
    .venv\\Scripts\\python.exe scripts/run_runtime_overhead.py --models mnist_mlp resnet18 gpt_mini
"""
import argparse
import sys
import time
...
def main():
    ...
    lines = ["# Experiment 6 -- Runtime overhead", "", C.ANALYZER_DISCLAIMER, "",
             ...
             "Exact command:", "", "```",
             "python scripts/run_runtime_overhead.py --models "
