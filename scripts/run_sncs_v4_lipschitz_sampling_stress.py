"""SNCS v4 -- Experiment 9: Sampled-L stress test.
...
Usage:
    .venv\\Scripts\\python.exe scripts/run_sncs_v4_lipschitz_sampling_stress.py
"""
import argparse
import sys
import time
...
def main():
    ...
    lines = ["# Experiment 9 -- Sampled-L stress test", "", C.ANALYZER_DISCLAIMER, "",
             ...
             "Exact command:", "", "```",
             "python scripts/run_sncs_v4_lipschitz_sampling_stress.py --models "
             + " ".join(args.models), "```", "",
