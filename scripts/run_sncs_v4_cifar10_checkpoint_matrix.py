"""SNCS v4 -- Experiment 5: Real CIFAR-10 checkpoint matrix.
...
Usage:
    .venv\\Scripts\\python.exe scripts/run_sncs_v4_cifar10_checkpoint_matrix.py
    .venv\\Scripts\\python.exe scripts/run_sncs_v4_cifar10_checkpoint_matrix.py --seeds 0 1 2 --subset 512 --pretrain-steps 10 --post-steps 12
"""
import argparse
import sys
import time
...
def main():
    ...
    lines = ["# Experiment 5 -- Real CIFAR-10 checkpoint matrix", "", C.ANALYZER_DISCLAIMER, "",
             ...
             "Exact command:", "", "```",
             f"python scripts/run_sncs_v4_cifar10_checkpoint_matrix.py --seeds "
