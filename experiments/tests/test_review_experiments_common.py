"""Tests for the shared infrastructure (scripts/review_experiments_common.py).

These validate the parts the review experiments depend on:
...
import review_experiments_common as C  # noqa: E402
